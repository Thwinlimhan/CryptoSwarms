...
from agents.research.bnbchain_catalog import bnbchain_skill_knowledge_base
...
def main() -> None:
    ...
    report = factory.run(query="bnbchain mcp tools erc8004 greenfield", now=datetime.now(timezone.utc), max_artifacts=10)
    ...
    out_dir = Path("artifacts") / "skill_factory" / "bnbchain"
    ...
    print("\n=== BNBChain Skill Factory summary ===")
    print(
        json.dumps(
            {
