...
from agents.research.cryptoskills_catalog import cryptoskills_knowledge_base
...
def main() -> None:
    ...
    report = factory.run(query="onchain defi derivatives tokenomics execution", now=datetime.now(timezone.utc), max_artifacts=10)
    ...
    out_dir = Path("artifacts") / "skill_factory" / "cryptoskills"
